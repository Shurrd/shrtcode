...
const Hero = () => {
  return (
    <section className="mt-10 flex flex-col gap-7 md:gap-0 md:flex-row items-center justify-between">
      ...
      <div className="w-[850px] sm:pl-0 pl-56 sm:w-full h-[350px] md:h-[250px] sm:h-full md:w-[800px] lg:w-full lg:h-full md:order-last order-first md:-mr-56 xl:-mr-44 lg:-mr-36">
        <img
